## lgsvl_msgs (foxy) - 0.0.4-1

The packages in the `lgsvl_msgs` repository were released into the `foxy` distro by running `/usr/bin/bloom-release lgsvl_msgs --rosdistro foxy --edit` on `Wed, 21 Oct 2020 23:42:23 -0000`
...
## lgsvl_msgs (eloquent) - 0.0.4-1

The packages in the `lgsvl_msgs` repository were released into the `eloquent` distro by running `/usr/bin/bloom-release lgsvl_msgs --rosdistro eloquent --edit` on `Wed, 21 Oct 2020 23:35:40 -0000`
...
## lgsvl_msgs (dashing) - 0.0.4-1

The packages in the `lgsvl_msgs` repository were released into the `dashing` distro by running `/usr/bin/bloom-release lgsvl_msgs --rosdistro dashing --edit` on `Wed, 21 Oct 2020 23:26:37 -0000`
...
## lgsvl_msgs (noetic) - 0.0.4-1

The packages in the `lgsvl_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release lgsvl_msgs --rosdistro noetic --edit` on `Wed, 21 Oct 2020 23:13:45 -0000`
...
## lgsvl_msgs (noetic) - 0.0.3-1

The packages in the `lgsvl_msgs` repository were released into the `noetic` distro by running `/usr/bin/bloom-release lgsvl_msgs --track noetic --rosdistro noetic --new-track` on `Mon, 01 Jun 2020 19:47:07 -0000`
